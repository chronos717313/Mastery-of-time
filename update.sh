...
echo -e "${GREEN}Restarting mkdocs container (nginx stays up)...${NC}"
# Force recreate mkdocs container to pick up new files
docker compose up -d --force-recreate --no-deps mkdocs
