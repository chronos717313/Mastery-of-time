...
> **[See the Lexicon](../lexique.md)** for complete definitions of $\tau(x)$, $\gamma_{\text{Després}}$, and all TMT terms.

[Back to Conceptual Bridges](index.md) | [Previous Bridge: Known Physics](physique_connue.md) | [Next Bridge: General Relativity](relativite_generale.md)
