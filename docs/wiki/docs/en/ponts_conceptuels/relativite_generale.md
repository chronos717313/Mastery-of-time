...
- **Després Mass**: $M_D = k \times \int(\Phi/c^2)^2 dV$ with universal law $k(M)$
- Curved geometry by scalar temporal field
...
> **[See the Lexicon](../lexique.md)** for complete definitions of all TMT terms.

[Back to Conceptual Bridges](index.md) | [Previous Bridge: Quantum Mechanics](mecanique_quantique.md) | [Next Bridge: Thermodynamics](thermodynamique.md)
