...
[:material-download: Descargar script completo](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_TMT_v2_SPARC_reel.py){ .md-button }
...
[:material-download: Descargar script completo](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/investigation_r_c_variation.py){ .md-button }
...
La ley k(M) se calibra en el mismo script que las [curvas de rotación](courbes_rotation/).
...
[:material-download: Descargar script completo](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_weak_lensing_TMT_vs_LCDM.py){ .md-button }
...
[:material-download: Descargar script completo](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_weak_lensing_TMT_vs_LCDM_real_data.py){ .md-button }
...
[:material-download: Descargar script completo](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_3_predictions_TMT.py){ .md-button }
...
[:material-download: Descargar script completo](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/calculate_ISW_improved.py){ .md-button }
...
[:material-download: Descargar script completo](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/calibrate_TMT_v23_cosmologie.py){ .md-button }
