...
> **[See the Lexicon](../lexicon.md)** for complete definitions of $\tau(x)$, $\gamma_{\text{Després}}$, and all TMT terms.

[Back to Conceptual Bridges](index.md) | [Previous Bridge: Known Physics](known_physics.md) | [Next Bridge: General Relativity](general_relativity.md)
