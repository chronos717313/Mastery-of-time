# Teoría de Dominio del Tiempo (TMT) - Versión Técnica Completa
...
*TMT - Versión lista para producción (Enero 2026)*</content>
<parameter name="filePath">docs/wiki/docs/es/version-complete.md