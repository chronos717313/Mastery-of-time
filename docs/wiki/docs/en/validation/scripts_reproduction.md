...
[:material-download: Download full script](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_TMT_v2_SPARC_reel.py){ .md-button }
...
[:material-download: Download full script](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/investigation_r_c_variation.py){ .md-button }
...
[:material-download: Download full script](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_weak_lensing_TMT_vs_LCDM.py){ .md-button }
...
[:material-download: Download full script](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_weak_lensing_TMT_vs_LCDM_real_data.py){ .md-button }
...
[:material-download: Download full script](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_3_predictions_TMT.py){ .md-button }
...
[:material-download: Download full script](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/calculate_ISW_improved.py){ .md-button }
...
[:material-download: Download full script](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/calibrate_TMT_v23_cosmologie.py){ .md-button }
