# Bridge 4: Thermodynamics

## Dark Energy Resolution

### ΛCDM: Mysterious Dark Energy
ΛCDM invokes **dark energy** representing 70% of the Universe:
- **Cosmological constant Λ** of unknown origin
...
- **Compatible with Planck CMB**
- **Supernova Ia predictions** confirmed

[Back to Conceptual Bridges](../index.md) | [Previous Bridge: General Relativity](relativite_generale.md) | [Next Bridge: Cosmology](cosmologie.md)