...
|------|----------|--------|--------|
| **[Courbes de rotation](courbes_rotation/) SPARC** | [156/156 galaxies (100%)](courbes_rotation/#criteres-dexclusion) | [:material-file-code:](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/test_TMT_v2_SPARC_reel.py) | ✅ VALIDÉ |
...
| **BTFR (37k galaxies)** | exposant 3.55 ± 0.09 | [:material-file-code:](https://github.com/chronos717313/Mastery-of-time/blob/main/scripts/calibration/analyse_BTFR_finale.py) | ✅ VALIDÉ |
...
Tests sur les [courbes de rotation](courbes_rotation/) des galaxies (SPARC, 156 galaxies).
