...
field $\psi$ (the \emph{temperon}) non-minimally coupled to the Ricci
...
\begin{itemize}
  \item $r_c\propto M_{\mathrm{bary}}^{1/2}$ in DESI/Euclid disk-galaxy
    ...
    derivation.
  \item Strict isotropy of the temperon contribution to weak
...
behaviour of the temperon at recombination; (ii) the application
