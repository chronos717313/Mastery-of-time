...
**Validation** : Relation $2\Phi/c^2 = 2 \times v^2/c^2$ vérifiée à 0.001% de précision dans le système solaire. Validations supplémentaires incluent les courbes de rotation SPARC (156 galaxies, 100% succès), isotropie du lensage faible (-0.024%), corrélation masse-environnement COSMOS2015 (r=0.150), effets environnement SNIa, ISW, et résolution de la tension H₀.
...
**Nature** : Effet **scalaire**, PAS une particule exotique.
...
| TMT | Effet scalaire de distorsion temporelle |
...
| Concept | ΛCDM | TMT |
|---------|------|-----|
| **Matière noire** | Particules WIMP/axions | Effet scalaire ($M_{\text{Després}}$) |
